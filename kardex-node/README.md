...
```
cd existing_repo
git remote add origin https://gitlab.com/aft-vc/chalkwalk/kardex/kardex-node.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/aft-vc/chalkwalk/kardex/kardex-node/-/settings/integrations)
